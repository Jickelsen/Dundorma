  ...
  render() {
    ...
    <div className="panel panel-default">
      <div className="panel-body no-margin">
        <div className={"form-group " + (this.state.name.length > 0 ? "has-success" : "has-warning")}>
        ...
        <div className={"form-group " + (this.emailValidate(this.state.email, this.state.emailConf) ? "has-success" : "has-warning")}>
          <label>Email</label>
        ...
        <div className={"form-group " + (this.passValidate(this.state.pass, this.state.passConf) ? "has-success" : "has-warning")}>
      ...
      <a href="/"><button className="btn btn-default">Cancel</button></a>
      <button className='btn btn-primary' onClick={() => this.updateProfile(this.state)} disabled={!ok}> Save Changes </button>
    </div>
    );
  }
}
